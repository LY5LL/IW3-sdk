...
namespace IW3 {
        ...
        struct centity_t*     GetCentity( int client_num );
        struct clientState_s* GetClientState( int client_num );
        struct entityState_t* GetClientEntityState( int client_num );
        struct clientinfo_t*  GetClientInfo( int client_num );

        qboolean IsEnemy( int client_num );
        qboolean IsDead( int client_num );
        qboolean IsValid( int client_num );
